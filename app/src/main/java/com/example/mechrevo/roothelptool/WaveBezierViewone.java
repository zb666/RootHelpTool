...
public class WaveBezierViewone extends View implements View.OnClickListener {
    private Path mPath;
    ...
    public WaveBezierViewone(Context context) {
        super(context);
    }

    public WaveBezierViewone(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public WaveBezierViewone(Context context, AttributeSet attrs, int defStyleAttr) {
